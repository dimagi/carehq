...
class IssueCategory(CategoryHandler):
    slug = CATEGORY_SLUG
...
IssueEventAssign = ActivityBridge(\
...
IssueEventComment = ActivityBridge(\
...
IssueEventResolve = ActivityBridge(\
...
IssueEventClose = ActivityBridge(\
