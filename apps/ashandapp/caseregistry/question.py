...
class QuestionEventOpen(ActivityBridge):
...
class QuestionEventView(ActivityBridge):
...
class QuestionEventEdit(ActivityBridge):
...
class QuestionEventAssign(ActivityBridge):
...
class QuestionEventComment(ActivityBridge):
...
class QuestionEventResolve(ActivityBridge):
...
class QuestionEventClose(ActivityBridge):
