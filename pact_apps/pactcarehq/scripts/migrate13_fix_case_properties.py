...
#        'last_bw_xml': '',
    ...
    #print update_dict
    caseblock = CaseBlock(case._id, owner_id=owner_id, external_id=patient_doc.pact_id, update=update_dict, user_id=str(user_id), date_opened=opened_date, close=False, date_modified=make_time().strftime("%Y-%m-%dT%H:%M:%SZ"))
    #caseblock = CaseBlock(case._id, owner_id=owner_id, external_id=patient_doc.pact_id, update=update_dict, case_type=case_type,case_name=case_name, user_id=str(user_id), date_opened=opened_date, close=False, date_modified=make_time().strftime("%Y-%m-%dT%H:%M:%SZ"))
