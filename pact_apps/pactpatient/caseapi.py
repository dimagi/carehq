...
def compute_case_create_block(patient_doc):
    ...
    submit_blocks(case_blocks, "compute_pactpatient_create_block")
...
def recompute_dots_casedata(patient_doc):
    ...
    case_blocks = [caseblock.as_xml(format_datetime=isodate_string)]
    submit_blocks(case_blocks, "compute_pactpatient_dots")
...
def compute_case_update_block(patient_doc):
    ...
    case_blocks = [caseblock.as_xml(format_datetime=isodate_string)]
    submit_blocks(case_blocks, "compute_pactpatient_update")
