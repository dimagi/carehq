...
def get_or_create_patient(tenant, patient_role, user=None, first_name=None, middle_name=None, last_name=None, gender=None):
    """
...
def generate_patient_and_careteam(tenant, team_dictionary=None, caregiver_role=None,  provider_role=None, primary_provider_role=None, patient_role=None):
    """
