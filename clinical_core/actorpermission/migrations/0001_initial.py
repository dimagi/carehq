...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('actorpermission', ['ClinicalUserProfile'])


    def backwards(self, orm):
        
        # Deleting model 'ClinicalUserProfile'
        db.delete_table('actorpermission_clinicaluserprofile')
