...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('patient_patient', (
            ('id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, primary_key=True)),
            ('doc_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, unique=True, null=True, blank=True)),
