...
FEMALE_NAMES = (
 ...
 "Vera", "Willie", "Charlene", "Bessie", "Delores", "Melinda", "Pearl",
 "Arlene", "Maureen", "Colleen", "Allison", "Tamara", "Joy", "Georgia",
 "Constance", "Lillie", "Claudia", "Jackie", "Marcia", "Tanya", "Nellie",
 ...
 "Hilda", "Gwendolyn", "Jennie", "Nora", "Margie", "Nina", "Cassandra", "Leah",
...
LAST_NAMES = (
 ...
 "Newman", "Haynes", "Mcdaniel", "Mendez", "Bush", "Vaughn", "Parks", "Dawson",
 ...
 "Malone", "Hammond", "Flowers", "Cobb", "Moody", "Quinn", "Blake", "Maxwell",
 "Pope", "Floyd", "Osborne", "Paul", "Mccarthy", "Guerrero", "Lindsey",
 "Estrada", "Sandoval", "Gibbs", "Tyler", "Gross", "Fitzgerald", "Stokes",
 "Doyle", "Sherman", "Saunders", "Wise", "Colon", "Gill", "Alvarado", "Greer",
 ...
 "Huffman", "Bradford", "Charles", "Gilmore", "Dominguez", "Oneal", "Bruce",
...
def random_female_name():
    return (random.choice(FEMALE_NAMES), random_last_name())

def random_last_name():
    return random.choice(LAST_NAMES)

def random_dob():
    start_ordinal = datetime.datetime(1920, 1,1).toordinal()
    end_ordinal = datetime.datetime.now().toordinal()
