...
#OS_PACKAGE_LIST_PATH_REDHAT = "../../../yum-packages.txt" #each package on a new line in this file
...
DJANGO_GIT_REPO_URL = "git://github.com/dimagi/carehq.git" #django project repo url
DJANGO_STAGING_GIT_BRANCH = "master"
DJANGO_STAGING_SERVER_NAME = "staging.some_project.com"
DJANGO_PRODUCTION_GIT_BRANCH = "ashandui-ticketing"
DJANGO_PRODUCTION_SERVER_NAME = "ashand.dimagi.com"
...
DJANGO_LOCALSETTINGS_REMOTE_DESTINATION = "ashand/localsettings.py" #RELATIVE TO THE CODE_ROOT ON REMOTE MACHINE
...
######## DB MODULE SETTINGS #####################
DB_DATABASE_NAME = "ashand" #name of database to be created
DB_DATABASE_USER = "ashand" #owner of new database
